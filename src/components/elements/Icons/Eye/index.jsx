  ...
  return (
    <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke="#FFFFFF"
      ></path>
      <circle id="Ellipse 159" cx="12" cy="12" r="5" stroke="#FFFFFF"></circle>
      <circle id="Ellipse 160" cx="12" cy="12" r="3" fill="#FFFFFF"></circle>
      <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="9" y="9" width="6" height="6">
        <circle id="Ellipse 163" cx="12" cy="12" r="3" fill="#FFFFFF"></circle>
      </mask>
      <circle id="Ellipse 161" opacity="0.89" cx="13.5" cy="10.5" r="1.5" fill="white"></circle>
    </svg>
  );
};
